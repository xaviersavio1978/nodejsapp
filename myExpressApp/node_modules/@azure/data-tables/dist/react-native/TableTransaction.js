...
import { getInitialTransactionBody, getTransactionHttpRequestBody, } from "./utils/transactionHelpers.js";
import { transactionHeaderFilterPolicy, transactionHeaderFilterPolicyName, transactionRequestAssemblePolicy, transactionRequestAssemblePolicyName, } from "./TablePolicies.js";
...
export class InternalTableTransaction {
    ...
    async submitTransaction(options = {}) {
        ...
        return tracingClient.withSpan("TableTransaction.submitTransaction", options, async (updatedOptions) => {
